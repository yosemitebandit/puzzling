""" via http://devosaurus.blogspot.com/2013/10/exploring-b-splines-in-python.html
"""
...
def draw_bspline(C=None, P=None, n=None, V_type=None, endpoint_epsilon=0.00001):
  ...
  if C:
    ...
    sampling = [t for t in numpy.linspace(C.min, C.max, 100,
                endpoint=C.endpoint)]
  ...
  figure.savefig('/tmp/devo.png', dpi=100)
